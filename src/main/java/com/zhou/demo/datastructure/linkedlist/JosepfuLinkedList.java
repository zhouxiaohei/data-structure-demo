...
public class JosepfuLinkedList {
    ...
    public static void main(String[] args) {
        ...
        circleSingleLinkedList.addBoy(225);// 加入5个小孩节点
        //circleSingleLinkedList.showBoy();

        //测试一把小孩出圈是否正确
        //circleSingleLinkedList.countBoy(10, 13, 225); // 2->4->1->5->3
        circleSingleLinkedList.countBoy2(10, 13, 225);
